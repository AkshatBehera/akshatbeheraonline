...
const Contact = () => {
  const [formData, setFormData] = useState({
    ...
    reply_email: '', // Changed from 'email'
    message: '',
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await emailjs.sendForm(
        'service_tto23vi', // Your Service ID
        'template_appukis', // Your Template ID
        e.target,
        'FOs-CFuHknoBigGUW' // Your User ID
      );
          ...
          >
            ...
            >
              ...
              <div className="flex justify-center space-x-3 sm:space-x-4">
                <a href="mailto:akshatbeheraonline@outlook.com" className="p-2 text-gray-600 transition-colors rounded-full dark:text-gray-400 hover:text-black dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800" aria-label="Email">
                  <FiMail size={18} className="sm:text-xl" />
                </a>
                <a href="https://x.com/akshatbehera" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-600 transition-colors rounded-full dark:text-gray-400 hover:text-black dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800" aria-label="X (formerly Twitter)">
                  <RiTwitterXFill size={18} className="sm:text-xl" />
                </a>
                <a href="https://linkedin.com/in/akshat-behera" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-600 transition-colors rounded-full dark:text-gray-400 hover:text-black dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800" aria-label="LinkedIn">
                  <FiLinkedin size={18} className="sm:text-xl" />
                </a>
                <a href="https://github.com/akshatbehera" target="_blank" rel="noopener noreferrer" className="p-2 text-gray-600 transition-colors rounded-full dark:text-gray-400 hover:text-black dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-800" aria-label="GitHub">
            ...
            >
              {status.submitted ? (
                <motion.div
                  className={`p-3 mb-4 rounded-lg sm:p-4 sm:mb-6 ${status.success ? 'bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300' : 'bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300'}`}
              ...
              <motion.div className="mb-3 sm:mb-4" variants={itemVariants}>
                <label htmlFor="user_name" className="block mb-1 text-sm font-medium sm:mb-2 sm:text-base">
                  Name
                </label>
                <input
                  type="text"
              ...
              <motion.div className="mb-3 sm:mb-4" variants={itemVariants}>
                <label htmlFor="reply_email" className="block mb-1 text-sm font-medium sm:mb-2 sm:text-base">
                  Email
                </label>
                <input
                  type="email"
                  id="reply_email"
                  name="reply_email" // Changed from 'email'
              ...
              {/* Hidden fields for additional template data */}
              <input
                type="hidden"
                name="submission_number"
                value={Math.floor(Math.random() * 10000)} // Random number for subject
              />
              <input
                type="hidden"
                name="date_time"
